...
/* harmony export */ });
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/modules/checkNumInputs");
...
const forms = state => {
  ...
  const postData = async (url, data) => {
    document.querySelector('.status').textContent = message.lodading;
...
const modals = () => {
  ...
  bindModal('.popup_calc_btn', '.popup_calc', '.popup_calc .popup_calc_close', false);
